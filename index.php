            ...
            <div class="barralateral">
                <aside>
                    ...
                    <ul>
                        ...
                        <br>
                        <li><a href="https://github.com/AaronCuattro">Github.</a></li>
                        <br>
                        <li><a href="https://discord.com">Discord.</a></li>
                        <br>
                        <li><a href="https://open.spotify.com/user/mastter.quattro?si=d37a9b7b5be54bf6">Spotify.</a></li>
                        <br>
                        <li><?php if(isset($_POST["control"])): ?><a href="imagenes/<?php echo $actividad->tipo ?>.jpg">Im&aacute;gen de la &uacute;ltima actividad creada.</a><?php else: ?><a href="imagenes/arbol.jpg">Im&aacute;gen</a><?php endif ?></li>
                    </ul>
                </aside>
            </div>
        </div>
