                ...
                <div id="tablaInicio">
                    <table>
                        <tr id="menuInicio">
                            ...
                            <td><?php if(isset($_POST["control"])): ?><a href="imagenes/<?php echo $actividad->tipo ?>.jpg">Im&aacute;gen de la &uacute;ltima actividad creada.</a><?php else: ?><a href="imagenes/eventos.jpeg">Im&aacute;gen eventos.</a><?php endif ?></td>
                            <td><a href="formulario.html">Formulario.</a></td>
                            <td><a href="claseActividades.php">Clase actividad php.</a></td>
                            <td><a href="styleCSS.css">Hoja de estilos.</a></td>
        ...
        <div id="divcuerpo">
                            ...
                            <?php else: ?>
                                <fieldset id="fieldset">
                                    ...
                                    <div class="resultado" > 
                                        ...
                                        <div class="img2" >
                                            <img src="imagenes/eventos.jpeg" alt="eventos">
                                        </div>
                                    </div>
                                </fieldset>
                            <?php endif ?> 
            ...
            <div class="barralateral">
                <aside>
                    <h4>Enlaces:</h4>
                    <ul>
                        <li><a href="mailto:aafmpw@gmail.com?Subject=Contacto%20desde%20p&aacute;gina%20web""><img class="icon" src="./imagenes/icon/google.png"></br>Gmail.</a></li>
                        </br>
                        ...
                        <li><?php if(isset($_POST["control"])): ?><a href="imagenes/<?php echo $actividad->tipo ?>.jpg"><img class="icon" src="./imagenes/icon/imagen.png"></br>Im&aacute;gen del evento creado.</a><?php else: ?><a href="imagenes/eventos.jpeg"><img class="icon" src="./imagenes/icon/imagen.png"></br>Im&aacute;gen eventos.</a><?php endif ?></li>
                    </ul>
                </aside>
            </div>
        </div>
